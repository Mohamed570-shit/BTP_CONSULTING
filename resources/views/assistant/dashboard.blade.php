    ...
    <div class="modal fade" id="addProjectModal" tabindex="-1" aria-labelledby="addProjectModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('assistant.projects.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
...
$(document).ready(function() {
    ...
    $('.view-project').on('click', function() {
        ...
        axios.get('/assistant/projects/' + projectId, {
            headers: {
    ...
    $('.edit-project').on('click', function() {
        ...
        $('#editProjectForm').attr('action', '{{ route("assistant.projects.update", "") }}/' + projectId);
        $('#edit_project_id').val(projectId);

        // Charger les données du projet
        $.ajax({
            url: '{{ route("assistant.projects.show", "") }}/' + projectId,
            type: 'GET',
            dataType: 'json',
    ...
    $('.delete-project').on('click', function() {
        var projectId = $(this).data('id');
        $('#deleteProjectForm').attr('action', '/assistant/projects/' + projectId);
    });
});
</script>
@endpush
